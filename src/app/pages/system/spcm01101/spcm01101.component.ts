...
@Component({
  selector: 'app-spcm01101',
  templateUrl: './spcm01101.component.html',
  styleUrls: ['./spcm01101.component.less']
})
export class Spcm01101Component extends BaseComponent implements OnInit {
  ...
  override DisplayScreenID: UrlDisplayId = UrlDisplayId.spcm01101;
  ...
  constructor(
   ...
   add() {
    let req = {
      "datacd": "Đơn vị tính",
      "datanm": "Đơn vị tính hiển thị",
      "datarnm": "Đơn vị tính dự phòng",
    }
