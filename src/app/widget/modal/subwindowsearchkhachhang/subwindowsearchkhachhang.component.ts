...
@Component({
  selector: 'app-subwindowsearchkhachhang',
  templateUrl: './subwindowsearchkhachhang.component.html',
  styleUrls: ['./subwindowsearchkhachhang.component.less']
})
export class SubwindowsearchkhachhangComponent implements OnInit {
